...
The inclusion restriction variable should be a predictor of the
missingness indicator for the variable of interest, but \emph{not} of
the actual value of the variable of interest. In this case, the data
were simulated to adhere to this requirement. Namely, \(\beta_{smoke}\)
