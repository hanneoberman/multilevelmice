...
- `mice::popmis` (simulated data on school kids, n = 199 units, N = 10 clusters, with MNAR/MAR mixture);
...
Toy example from [Heckman Github repo](https://github.com/johamunoz/Heckman-IPDMA/blob/main/Toy_example.R). We will use the following variables:
