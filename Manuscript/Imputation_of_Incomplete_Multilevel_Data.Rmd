...
author:
  ...
  - name: Valentijn M. T. de Jong
    affiliation: Julius Center for Health Sciences and Primary Care, University Medical Center Utrecht, Utrecht University, Utrecht, The Netherlands \AND Data Analytics and Methods Task Force, European Medicines Agency, Amsterdam, The Netherlands
...
ggplot(dat, aes(x = cols, y = rows)) +
  ...
  coord_cartesian(expand = c(0)) + #Changed to run GV
