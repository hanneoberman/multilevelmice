...
abstract: >
  This tutorial illustrates the imputation of incomplete multilevel data with the \proglang{R} packackage \pkg{mice}. 
keywords:
...
```{r patterns, fig.height=1.5, fig.width=4.1, fig.cap = "Sporadic missingness in multilevel data", echo=FALSE}
...
plot_pattern(popmis, square = TRUE)
```
