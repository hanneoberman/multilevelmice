...
Create a predictor matrix and remove `school` as predictor for `popular`:

```{r pop_ignored, echo=TRUE, message=FALSE, warning=FALSE}
# predictor matrix
pred <- quickpred(popmis)
plot_pred(pred)
