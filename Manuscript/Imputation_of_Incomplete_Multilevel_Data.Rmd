...
- `obesity` from the \pkg{miceheckman} package [simulated data on obesity, $n = 2,111$ patients across $N = 5$ regions with data that are MNAR].
...
The imputation of these data is based on the toy example from [IPDMA Heckman Github repo](https://github.com/johamunoz/Heckman-IPDMA/blob/main/Toy_example.R) [TODO: add reference Arxiv paper Johanna]. 
