...
TODO: make a 'translation table' between model equation and lme4. Use betas instead of gamma's and mu's.
...
impact_NA <- readRDS("../Data/impact_NA.RDS") #%>% select(!c(hypox, hypots, tsah, edh))
...
mod_cca_dummy <- glm(mort ~ type + age + motor_score + pupil + ct + as.factor(name), family = "binomial", data = impact_NA) 
