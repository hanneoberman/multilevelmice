...
`glmer(mort ~ 1 + type + age + motor_score + pupil + ct + hypox + hypots + tsah + edh + (1 | name))`
...
```{r impact_cca}
mod_cca <- glmer(mort ~ type + age + motor_score + pupil + ct + (1 | name), family = "binomial", data = impact_NA) 
