...
```{r, dpi = 300,out.width="70%", fig.cap="Missing pattern", eval=FALSE}
library(ggpubr)
...
```{r obesity-predmar,out.width="70%", eval=FALSE}
...
```{r obesity-predmnar1, eval=FALSE}
meth_mnar <- meth_mar
...
```{r obesity-predmnar2,eval=FALSE}
...
```{r obesity-predmnar3,eval=FALSE}
summary(complete(imp_mnar,"long")$Weight)
```
...
```{r obesity-predmnarp, eval=FALSE}
...
```{r obesity-predmnarp1, eval=FALSE}
