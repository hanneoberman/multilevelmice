...
\end{CodeInput}
\begin{CodeOutput}
   hiv         hivconsent          age                     marital    
 0   :4457   Min.   :0.0000   Min.   :15.00   never_married    :2513  
 1   : 641   1st Qu.:1.0000   1st Qu.:20.00   currently_married:3582  
 NA's:1318   Median :1.0000   Median :28.00   formerly_married : 321  
             Mean   :0.7946   Mean   :30.12                           
             3rd Qu.:1.0000   3rd Qu.:37.00                           
             Max.   :1.0000   Max.   :59.00                           
...
\end{CodeOutput}
\begin{CodeInput}
R> # source("mice.impute.2l.heckman.R")
R> # sum(as.numeric(data_imp_mar[["imp"]][["hiv"]][["1"]]))
R> # sum(as.numeric(data_imp_heckp[["imp"]][["hiv"]][["1"]]))
R> # sum(as.numeric(data_imp_mar[["imp"]][["hiv"]][["2"]]))
R> # sum(as.numeric(data_imp_heckp[["imp"]][["hiv"]][["2"]]))
R> 
R> # Heckman model
...
R> 
R> data_imp_heckp <- mice( hivdata, # dataset with missing values
+                         m = 10,   # number of imputations
