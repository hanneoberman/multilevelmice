...
{\centering \includegraphics{Imputation_of_Incomplete_Multilevel_Data_files/figure-latex/unnamed-chunk-3-1} 

}

\caption[True effect in the popularity data]{True effect in the popularity data}\label{fig:unnamed-chunk-3}
\end{figure}
\end{CodeChunk}
