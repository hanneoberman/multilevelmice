...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, leftrule=.75mm, colback=white, bottomrule=.15mm, toprule=.15mm, left=2mm, rightrule=.15mm, opacityback=0]
...
\includegraphics{manuscript_files/figure-pdf/unnamed-chunk-5-2.pdf}
...
{\centering \includegraphics{manuscript_files/figure-pdf/unnamed-chunk-6-1.pdf}
